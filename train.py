...
if 1:
    ...
    # Dataset.
    desc += '-concat';     dataset = EasyDict(tfrecord_dir='concat');                 train.mirror_augment = False
    #desc += '-skin';     dataset = EasyDict(tfrecord_dir='skin');                 train.mirror_augment = True
    ...
    sched.G_lrate_dict = {8: 0.00015, 16: 0.00015, 32:0.00015, 64: 0.00015, 128: 0.00015, 256: 0.0002, 512: 0.0002, 1024: 0.0002}
